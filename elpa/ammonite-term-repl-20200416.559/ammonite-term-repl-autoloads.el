...
Send the definition to the ammonite buffer." t nil)
...
Send the buffer to the ammonite buffer." t nil)
...
If called interactively, enable Ammonite-Term-Repl minor mode if
