...
(defun ido-exit-raise-frame
  (let ((ido-default-file-method  'raise-frame))
    (exit-minibuffer)))

(defun ido-exit-other-frame
  (let ((ido-default-file-method  'other-frame))
    (exit-minibuffer)))

(defun ido-exit-other-window
  (let ((ido-default-file-method  'window-frame))
    (exit-minibuffer)))
