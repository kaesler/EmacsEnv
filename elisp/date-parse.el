...
;; @(#) $Id: date-parse.el,v 1.2 1998/02/20 15:46:24 jaalto Exp $

;; This file is not part of Emacs

;;{{{ Id

;; Copyright (C)    1989 John Rose <rose@think.com>
;; Author:          ohn Rose <rose@think.com>
;; $Maintainer:     (none) $
;; $Packaged-by:    <jari.aalto@poboxes.com> $
;; $Created:        1989-03 $
;; $Keywords:       extensions $
;;
...
;; 1997-11-27|$Revision: 1.2 $|~/misc/date-parse.el.Z|
